...
export const metadata: Metadata = {
  title: "BrewHaven | Premium Specialty Coffee Shop",
  description: "Discover artisan specialty coffee crafted by expert baristas. Fresh pastries, cozy ambiance, and ethical bean sourcing. Visit BrewHaven today.",
  keywords: "specialty coffee, coffee shop, barista, latte, cappuccino, espresso, cafe",
  openGraph: {
    title: "BrewHaven | Premium Specialty Coffee Shop",
    description: "Experience exceptional coffee crafted with passion. Expert baristas, cozy ambiance, fresh pastries.",
    type: "website",
    siteName: "BrewHaven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1766055676346-mj2rfcmy.jpg",
        alt: "BrewHaven specialty coffee"
      }
    ]
  },
  twitter: {
    ...
    description: "Exceptional coffee crafted by expert baristas in a cozy atmosphere."
  }
};
